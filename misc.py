...
from data.config import stalker_client_id
from data.config import stalker_client_secret
...
intra_requests_stalking = IntraRequests(stalker_client_id, stalker_client_secret)
