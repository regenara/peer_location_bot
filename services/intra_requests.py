...
class IntraRequests:
    ...
    async def get_project_peers(self, project_id: int, campus_id: int, time_zone: str):
        ...
        :return: Словарь со списком пользователей, выполнивших проект за последние 4 недели (максимум 50).
        Если пользователей менее 30, то количество недель увеличивается в три раза тех пор,
